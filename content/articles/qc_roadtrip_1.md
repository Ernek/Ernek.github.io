...
> **qubits** can be in a _state_ other than |0> and |1>. They can also be in any possible _linear combination_ of states: ![superposition state]({filename}/images/superposition.png)     
